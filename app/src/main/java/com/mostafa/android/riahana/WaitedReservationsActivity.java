...
public class WaitedReservationsActivity extends AppCompatActivity {
    RecyclerView rv;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txNo = (TextView)findViewById(R.id.txNo2);
            ...
            public void onResponse(String response) {
                try {
                    ...
                    if(jsonArray.getJSONObject(0).has("date_time")) {
                        ...
                        LinearLayoutManager llm = new LinearLayoutManager(WaitedReservationsActivity.this);
...
//                         Toast.makeText(context, " "+, Toast.LENGTH_SHORT).show();
        ...
        RequestQueue queue = Volley.newRequestQueue(WaitedReservationsActivity.this);
